...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="">
		...
		<div class="tDiv2">
			...
			<div class="fbutton">
				<div>
					<span class=""><?php echo $this->l('list_add'); ?> <?php echo $subject?></span>
				</div>
			</div>
            </a>
			<div class="">
		...
		<div class="tDiv3">
			...
			<?php } ?>
			<?php if(!$unset_print) { ?>
        	<a class="btn btn-info" data-url="<?php echo $print_url; ?>">
				<div class="fbutton">
					<div>
	...
	<div class="pDiv">
		<div class="pDiv2">
			...
			<div class="pGroup" style="padding-top: 4px;">
				<div class="pButton first-button">
					<span><i class="fa-solid fa-angles-left" style="color: #0074cc;font-weight: bold;font-size: 15px;"></i></span>
				</div>
				<div class="pButton prev-button">
					<span><i class="fa-solid fa-chevron-left" style="color: #0074cc;font-weight: bold;font-size: 15px;"></i></span>
				</div>
			</div>
			<div class="">
			</div>
			...
			<div class="pGroup" style="padding-top: 4px;">
				<div class="pButton next-button" >
					<span><i class="fa-solid fa-angle-right" style="color: #0074cc;font-weight: bold;font-size: 15px;"></i></span>
				</div>
				<div class="pButton last-button">
					<span><i class="fa-solid fa-angles-right" style="color: #0074cc;font-weight: bold;font-size: 15px;"></i></span>
				</div>
			</div>
			<div class="">
			</div>
			<div class="pGroup" style="padding-top: 4px;">
				<div class=" pButton ajax_refresh_and_loading" id='ajax_refresh_and_loading'>
					<span><i class="fa-solid fa-arrows-rotate" style="color: #0074cc;font-weight: bold;font-size: 15px;"></i></span>
				</div>
			</div>
			<div class="">
			</div>
